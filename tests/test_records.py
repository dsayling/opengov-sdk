...
class TestRecordsEdgeCases:
    ...
    def test_get_record_with_special_characters(
        ...
        httpx_mock.add_response(
            url=f"https://api.plce.opengov.com/plce/v2/testcommunity/records/{record_id}",
...
class TestRecordCRUD:
    ...
    def test_create_record(self, httpx_mock: HTTPXMock, configure_client):
    ...
    def test_update_record(self, httpx_mock: HTTPXMock, configure_client):
    ...
    def test_archive_record(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordForm:
    ...
    def test_get_record_form(self, httpx_mock: HTTPXMock, configure_client):
        """Test getting record form data."""
        url = "https://api.plce.opengov.com/plce/v2/testcommunity/records/123/form"
        httpx_mock.add_response(url=url, json={"data": {"fields": []}})

        result = opengov_api.get_record_form("123")
        assert "data" in result

    def test_update_record_form(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordApplicant:
    ...
    def test_get_record_applicant(self, httpx_mock: HTTPXMock, configure_client):
        """Test getting record applicant."""
        url = "https://api.plce.opengov.com/plce/v2/testcommunity/records/123/applicant"
    ...
    def test_update_record_applicant(self, httpx_mock: HTTPXMock, configure_client):
    ...
    def test_remove_record_applicant(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordGuests:
    ...
    def test_get_record_guest(self, httpx_mock: HTTPXMock, configure_client):
        """Test getting a specific record guest."""
        url = "https://api.plce.opengov.com/plce/v2/testcommunity/records/123/guests/user-1"
        httpx_mock.add_response(url=url, json={"data": {"id": "user-1"}})

        result = opengov_api.get_record_guest("123", "user-1")
        assert result["data"]["id"] == "user-1"

    def test_remove_record_guest(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordLocations:
    ...
    def test_get_record_primary_location(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordAttachments:
    ...
    def test_get_record_attachment(self, httpx_mock: HTTPXMock, configure_client):
        """Test getting a specific record attachment."""
        url = "https://api.plce.opengov.com/plce/v2/testcommunity/records/123/attachments/att-1"
        httpx_mock.add_response(url=url, json={"data": {"id": "att-1"}})

        result = opengov_api.get_record_attachment("123", "att-1")
        assert result["data"]["id"] == "att-1"

    def test_remove_record_attachment(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordChangeRequests:
    ...
    def test_get_record_change_request(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordWorkflowSteps:
    ...
    def test_get_record_workflow_step(self, httpx_mock: HTTPXMock, configure_client):
        """Test getting a specific workflow step."""
        url = "https://api.plce.opengov.com/plce/v2/testcommunity/records/123/workflow-steps/step-1"
        httpx_mock.add_response(url=url, json={"data": {"id": "step-1"}})

        result = opengov_api.get_record_workflow_step("123", "step-1")
        assert result["data"]["id"] == "step-1"

    def test_update_record_workflow_step(self, httpx_mock: HTTPXMock, configure_client):
    ...
    def test_delete_record_workflow_step(self, httpx_mock: HTTPXMock, configure_client):
...
class TestRecordCollections:
    ...
    def test_get_record_collection_entry(self, httpx_mock: HTTPXMock, configure_client):
